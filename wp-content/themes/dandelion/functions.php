 ...
 * ------------------------------------------------------------------------*/
require_once (PEXETO_FUNCTIONS_PATH.'aq_resizer.php');  //image resizing script
require_once (PEXETO_FUNCTIONS_PATH.'image-crop-from-position.php');  //image resizing script
