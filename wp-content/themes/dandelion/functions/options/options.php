...
if ( !function_exists( 'mytheme_add_admin' ) ) {
	...
	function mytheme_add_admin() {
		...
		add_theme_page( $themename." Options", "".$themename." Options", 'edit_theme_options', 'options', 'pexeto_theme_admin' );
	}
}

require_once 'pexeto_options_manager.php';
$pexeto_options_manager=new PexetoOptionsManager( $themename, PEXETO_OPTIONS_URL, PEXETO_FUNCTIONS_URL, PEXETO_UPLOADS_URL, PEXETO_VERSION, PEXETO_IMAGES_URL );
