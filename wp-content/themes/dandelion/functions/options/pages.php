...
array(
"name" => "Gallery post type slider autoplay",
"id" => $shortname."_nivo_post_autoplay",
"type" => "checkbox",
"std" => 'off',
"desc" => 'When enabled, the slider in the gallery format posts will be set to autoplay'),
...
"std" => "An error occurred, the message was not sent."
),
